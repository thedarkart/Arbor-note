...
- [Unit 2: DDoS Overview](#unit-2-ddos-overview)
  ...
  - [Impact of DDoS](#impact-of-ddos)
    - [DDoS Attacks is more complex:](#ddos-attacks-is-more-complex)
    - [Business impact:](#business-impact)
    - [Common DDoS attacks types:](#common-ddos-attacks-types)
    - [DDoS Attack surface:](#ddos-attack-surface)
  - [DOS Alert Activity](#dos-alert-activity)
    - [DOS Alert Summaries](#dos-alert-summaries)
    - [Multiple host Misuse Types](#multiple-host-misuse-types)
...
### Multiple host Misuse Types

- Same targeted IP of a Managed Object will be aggregated into a single alert
